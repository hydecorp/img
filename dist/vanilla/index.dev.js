...
var util_root = __webpack_require__(1);
...
var HyImage = function (_imageMixin) {
  vanilla__inherits(HyImage, _imageMixin);

  function HyImage() {
    vanilla__classCallCheck(this, HyImage);

    return vanilla__possibleConstructorReturn(this, (HyImage.__proto__ || Object.getPrototypeOf(HyImage)).apply(this, arguments));
  }

  return HyImage;
}(mixin_imageMixin(VanillaComponent));
