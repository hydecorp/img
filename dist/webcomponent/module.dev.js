  ...
  return function (_rxjsMixin) {
    ...
    _createClass(_class, [{
      ...
      value: function connectComponent() {
        ...
        var sizerStyle$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.resize$, this.subjects.width, this.subjects.height).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.subjects.disconnect));
      ...
      value: function makeRequest(_ref14) {
        ...
        if (isIntersecting && !cache.has(href)) {
          ...
          return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["never"])();
        }
      }
    }, {
