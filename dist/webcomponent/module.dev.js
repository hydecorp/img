(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("hyImg", [], factory);
	else if(typeof exports === 'object')
		exports["hyImg"] = factory();
	else
		root["hyImg"] = factory();
})(window, function() {
...
/*!***********************!*\
  !*** ./src/common.js ***!
  \***********************/
/*! exports provided: hasCSSOM, createXObservable, createIntersectionObservable, createResizeObservable, isExternal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var createIntersectionObservable = createXObservable(window.IntersectionObserver);
var createResizeObservable = createXObservable(window.ResizeObserver);
...
/*!****************************!*\
  !*** ./src/mixin/index.js ***!
  \****************************/
/*! exports provided: MIXIN_FEATURE_TESTS, imageMixin */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MIXIN_FEATURE_TESTS", function() { return MIXIN_FEATURE_TESTS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "imageMixin", function() { return imageMixin; });
...
/* harmony import */ var rxjs_esm5_ajax__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/_esm5/ajax */ "./node_modules/rxjs/_esm5/ajax/index.js");
/* harmony import */ var rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/_esm5/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common */ "./src/common.js");
/* harmony import */ var _srcset__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./srcset */ "./src/mixin/srcset.js");
...
var MIXIN_FEATURE_TESTS = new hy_component_src_component__WEBPACK_IMPORTED_MODULE_0__["Set"]([].concat(_toConsumableArray(hy_component_src_component__WEBPACK_IMPORTED_MODULE_0__["COMPONENT_FEATURE_TESTS"]), ["eventlistener", "queryselector", "requestanimationframe"]));

var imageMixin = function imageMixin(C) {
  return function (_rxjsMixin) {
    _inherits(_class, _rxjsMixin);
    ...
    _createClass(_class, [{
      ...
      value: function setupComponent(el, props) {
        ...
        this.loadImage$ = new rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
      }
    }, {
      key: "connectComponent",
      value: function connectComponent() {
        ...
        if (_common__WEBPACK_IMPORTED_MODULE_6__["hasCSSOM"]) this.img.attributeStyleMap.set("display", "block");else this.img.style.display = "block";
        ...
        var initialRect = { contentRect: this.el.getBoundingClientRect() };

        this.resize$ = "ResizeObserver" in window ? Object(_common__WEBPACK_IMPORTED_MODULE_6__["createResizeObservable"])(this.el).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(initialRect)) : Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["of"])(initialRect);

        // Prefer `width` over `data-width`.
        var selector = function selector(a, b) {
          return a || b;
        };
        var width$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.subjects.width, this.subjects.dataWidth, selector);
        var height$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.subjects.height, this.subjects.dataHeight, selector);

        var dimensions$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.resize$, width$, height$);

        var isIntersecting$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.subjects.root, this.subjects.rootMargin).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (_ref) {
          var _ref2 = _slicedToArray(_ref, 2),
              root = _ref2[0],
              rootMargin = _ref2[1];

          return "IntersectionObserver" in window ? Object(_common__WEBPACK_IMPORTED_MODULE_6__["createIntersectionObservable"])(_this2.el, { root: root, rootMargin: rootMargin }) : Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["of"])({ isIntersecting: true });
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (_ref3) {
          var isIntersecting = _ref3.isIntersecting;
          return isIntersecting;
        }));

        this.trigger$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["merge"])(isIntersecting$, this.loadImage$).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["share"])());

        // Subscriptions:
        dimensions$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.subjects.disconnect)).subscribe(this.updateSizerStyle.bind(this));

        this.trigger$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (x) {
          return x;
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])()).subscribe(this.triggered.bind(this));
      ...
      value: function triggered() {
        ...
        var srcset$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.subjects.src, this.subjects.srcset).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (_ref4) {
          var _ref5 = _slicedToArray(_ref4, 2),
              a = _ref5[0],
              b = _ref5[1];

          return a != null || b != null;
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])(function (_ref6, _ref7) {
          ...
          return p1 === q1 && p2 === q2;
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (_ref10) {
          var _ref11 = _slicedToArray(_ref10, 2),
              src = _ref11[0],
              srcset = _ref11[1];

          return srcset ? Object(_srcset__WEBPACK_IMPORTED_MODULE_7__["parseSrcset"])(srcset) : Object(_srcset__WEBPACK_IMPORTED_MODULE_7__["srcsetFromSrc"])(src);
        }));

        var url$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.resize$, srcset$).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(this.selectImgURL.bind(this)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilKeyChanged"])("href"));

        var isIntersecting$ = this.trigger$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])(), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(true));

        var img$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(url$, isIntersecting$).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
          return _this3.loading && _this3.loading.removeAttribute("hidden");
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(this.makeRequest.bind(this)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(this.setImgSrcAndLoad.bind(this)));

        // #### Subscriptions
        // Whenever the object URL changes, we set the new image source.
        img$.subscribe(function () {
          if (_this3.sizer.parentNode != null) _this3.el.removeChild(_this3.sizer);
          if (_this3.img.parentNode == null) _this3.el.appendChild(_this3.img);
          _this3.fireEvent("load");
        },
      ...
      value: function makeRequest(_ref14) {
        ...
        if (isIntersecting && !cache.has(href)) {
          return Object(rxjs_esm5_ajax__WEBPACK_IMPORTED_MODULE_4__["ajax"])({
            method: "GET",
            responseType: "blob",
            url: url,
            crossDomain: Object(_common__WEBPACK_IMPORTED_MODULE_6__["isExternal"])(url),
            headers: { Accept: "image/*" }
          }).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (_ref16) {
            var response = _ref16.response;
            return URL.createObjectURL(response);
          }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (objectURL) {
            return cache.set(href, objectURL);
          }));
        } else if (cache.has(href)) {
          return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["of"])(cache.get(href));
        } else {
          return rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["NEVER"];
        }
      }
    }, {
      key: "setImgSrcAndLoad",
      value: function setImgSrcAndLoad(url) {
        var load$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this.img, "load");
        this.img.src = url;
        return load$;
      }
      ...
      value: function updateAttr(name) {
        ...
        return function (x) {
          return x == null || x === false ? _this4.img.removeAttribute(name) : _this4.img.setAttribute(name, x === true ? "" : x);
        };
      ...
      value: function updateSizerStyle(_ref17) {
        ...
        if (_common__WEBPACK_IMPORTED_MODULE_6__["hasCSSOM"]) {
      ...
      get: function get() {
        return {
          root: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"],
          rootMargin: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"],
          src: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"],
          srcset: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"],
          width: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["number"],
          height: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["number"],
          dataWidth: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["number"],
          dataHeight: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["number"],
          alt: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"],
          decoding: Object(hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["oneOf"])(["sync", "async", "auto"]),
          longdesc: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"],
          ismap: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["bool"],
          usemap: hy_component_src_types__WEBPACK_IMPORTED_MODULE_2__["string"]
          /*
    ...
    return _class;
  }(Object(hy_component_src_rxjs__WEBPACK_IMPORTED_MODULE_1__["rxjsMixin"])(Object(hy_component_src_component__WEBPACK_IMPORTED_MODULE_0__["componentMixin"])(C)));
};
...
/*!***********************************!*\
  !*** ./src/webcomponent/index.js ***!
  \***********************************/
/*! exports provided: WEBCOMPONENT_FEATURE_TESTS, Set, HyImageElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HyImageElement", function() { return HyImageElement; });
...
var HyImageElement = function (_customElementMixin) {
  _inherits(HyImageElement, _customElementMixin);

  function HyImageElement() {
    _classCallCheck(this, HyImageElement);

    return _possibleConstructorReturn(this, (HyImageElement.__proto__ || Object.getPrototypeOf(HyImageElement)).apply(this, arguments));
  }

  _createClass(HyImageElement, [{
    key: "getTemplate",
    value: function getTemplate() {
      return null;
    }
...
}(Object(hy_component_src_custom_element__WEBPACK_IMPORTED_MODULE_0__["customElementMixin"])(Object(_mixin__WEBPACK_IMPORTED_MODULE_1__["imageMixin"])(hy_component_src_custom_element__WEBPACK_IMPORTED_MODULE_0__["CustomElement"])));
...
var define = function define() {
  return window.customElements.define("hy-img", ShyImageElement);
};
