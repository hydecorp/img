...
/*!***********************!*\
  !*** ./src/common.js ***!
  \***********************/
/*! exports provided: hasCSSOM, isExternal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_rxjsMixin) {
      ...
      _createClass(_class, [{
        ...
        value: function connectComponent() {
          ...
          this.sizer = document.createElement("div"); // TODO: update loading when dom changes... use shadow dom after all?

          this.loading = this.el.querySelector('[slot="loading"]');
          if (this.loading) this.sizer.appendChild(this.loading); // TODO: don't force inline styles
          ...
          this.el.appendChild(this.sizer); // TODO: This triggers are layout event for every hy-img,
          // but we need to get the width of the image somehow.

          var initialRect = {
            contentRect: this.el.getBoundingClientRect()
          };
          this.resize$ = "ResizeObserver" in window ? Object(hy_component_src_rxjs__WEBPACK_IMPORTED_MODULE_1__["createXObservable"])(ResizeObserver)(this.el).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(initialRect)) : Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["of"])(initialRect); // Prefer `width` over `data-width`.
          ...
          var isIntersecting$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.subjects.root, this.subjects.rootMargin).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (_ref) {
            ...
            return "IntersectionObserver" in window ? Object(hy_component_src_rxjs__WEBPACK_IMPORTED_MODULE_1__["createXObservable"])(IntersectionObserver)(_this.el, {
              root: root,
              rootMargin: rootMargin
            }) : Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["of"])({
              isIntersecting: true
            });
          ...
          this.trigger$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["merge"])(isIntersecting$, this.loadImage$).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["share"])()); // Subscriptions:
          ...
          this.trigger$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (x) {
            return x;
          }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])()).subscribe(this.triggered.bind(this)); // Firing an event to let the outside world know the drawer is ready.
        ...
        value: function triggered() {
          ...
          }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(this.makeRequest.bind(this)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(this.setImgSrcAndLoad.bind(this))); // #### Subscriptions
          ...
          if (_common__WEBPACK_IMPORTED_MODULE_6__["hasCSSOM"]) {
            ...
            if (width != null && height != null) {
              if (width >= contentWidth) {
                ...
                this.sizer.style.paddingTop = "".concat(height / width * 100, "%");
              } else {
                this.sizer.style.width = "".concat(width, "px");
                this.sizer.style.height = "".concat(height, "px");
              }
            } else {
              this.sizer.style.width = "100%";
...
function (_customElementMixin) {
  ...
  function HyImageElement() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(HyImageElement).apply(this, arguments));
  }
