...
} var s = e.namespace || "HyImg"; return H || (H = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
} } function a(n) { n.S && n.S(n.C), p(n); } function s(n, t) { n.A === T && (n.C = t, n.A = W, 0 !== n._.length && g(p, n)); } function l(n, t) { n.A === T && (n.A = x, n.C = t, g(a, n)); } function v(n, t, e, r) { var i = n._, o = i.length; n.S = null, i[o] = t, i[o + W] = e, i[o + x] = r, 0 === o && n.A && g(p, n); } function p(n) { var t = n._, e = n.A; if (0 !== t.length) {
...
var c = "$", a = {}, s = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    if ("style" === e) {
        ...
        e = v(e) in t ? v(e.substring(2)) : v(e[2]) + e.substring(3), i ? i !== r && n.Z.fn(t, e, i, 0) : n.Z.cn(t, e, 0);
else if (r !== i) {
    var a = b(r), s = b(i), l = a.filter(function (n) { return !s.includes(n); }), p = b(t.className).filter(function (n) { return !l.includes(n); }), d = s.filter(function (n) { return !a.includes(n) && !p.includes(n); });
    ...
    case 12: return [2];
} }); }); }, T = function (n, t, e, r, i, o, u) { (u = n.Sn.get(t)) || n.Sn.set(t, u = {}); var f = u[e]; if (r !== f && (u[e] = r, o = n.Mn.get(t))) {
    var c = u[P + e];
    if (c)
    ...
    i = new (o = n.nn(t).$n), function (n, t, e, r, i, o) { n._n.set(r, e), n.Sn.has(e) || n.Sn.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], f = t[1]; (function (n, t, e, r, i, o, u, f, c) { if (t.type || t.state) {
        var a = n.Sn.get(e);
        t.state || (!t.attr || void 0 !== a[i] && "" !== a[i] || (f = o && o.Tn) && l(c = f[t.attr]) && (a[i] = O(t.type, c)), e.hasOwnProperty(i) && (void 0 === a[i] && (a[i] = O(t.type, e[i])), "mode" !== i && delete e[i])), r.hasOwnProperty(i) && void 0 === a[i] && (a[i] = r[i]), t.watchCallbacks && (a[P + i] = t.watchCallbacks.slice()), x(r, i, function s(t) { return (t = n.Sn.get(n._n.get(this))) && t[i]; }, function v(e, r) { (r = n._n.get(this)) && (t.state || t.mutable) && T(n, r, i, e, u); });
    }
    else
        t.elementRef ? W(r, i, e) : t.method && W(e, i, r[i].bind(r)); })(n, f, e, r, u, i, o); }); }(n, o, t, i, e, r);
}
catch (e) {
    i = {}, n.kn(e, 7, t, !0);
...
} return !0; }, L = function (n, t, e, r, i, o) { if (n.yn.delete(t), (i = n.gn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.gn.delete(t)), n.xn.length && !n.yn.size)
    for (; o = n.xn.shift();)
        ...
        catch (n) { } return 1 === t.G && n.Y && !e.shadowRoot && n.tt(e, { mode: "open" }), r = { Tn: {} }, t.tn && Object.keys(t.tn).forEach(function (o) { (i = t.tn[o].rn) && (r.Tn[i] = n.Zn(e, i)); }), r; }(n.Z, t, e)), n.ot(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { if (!n.ut && function (n, t) { for (; t;) {
        if (!n.Un(t))
            return 9 !== n.Nn(t);
        t = n.Un(t);
    } }(n.Z, t)) {
        ...
        var e = n.Mn.get(t);
        e && e.componentDidUnload && e.componentDidUnload(), n.Z.cn(t), n.ft.delete(t), n.l && n.l.removeHost(t), [n.gn, n.ct, n.jn].forEach(function (n) { return n.delete(t); });
    } })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (R(n, t) && n.Mn.get(t) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.it.set(t, !0), n.at.has(t) || (n.at.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
            j(n.On.get(t)), (o = n.ct.get(t)) && (o.forEach(function (n) { return n(t); }), n.ct.delete(t));
        }
        catch (e) {
            n.kn(e, 4, t);
        }
    ...
    } S(b, t, f); }); }, Cn: !1, bn: !1, ut: !1, An: s, gn: new WeakMap, K: new WeakMap, Wn: new WeakMap, ft: new WeakMap, at: new WeakMap, it: new WeakMap, _n: new WeakMap, jn: new WeakMap, Mn: new WeakMap, mn: new WeakMap, wn: new WeakMap, ct: new WeakMap, lt: new WeakMap, On: new WeakMap, Sn: new WeakMap, yn: new Set, xn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, p.h = e, p.Context = t, p.onReady = function () { return new Promise(function (n) { return b.queue.write(function () { return b.yn.size ? b.xn.push(n) : n(); }); }); }, b.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, v, p, d, h, y, w, b, m) { if (b = v.vchildren[p], e || (o = !0, "slot" === b.vtag && (r && t.En(d, r + "-s"), b.vchildren ? b.vt = !0 : b.pt = !0)), l(b.vtext))
    b.i = t.Ln(b.vtext);
else if (b.pt)
    b.i = t.Ln("");
else {
    if (y = b.i = g || "svg" === b.vtag ? t.Rn("http://www.w3.org/2000/svg", b.vtag) : t.V(b.vt ? "slot-fb" : b.vtag), n.rt(y) && n.it.delete(c), g = "svg" === b.vtag || "foreignObject" !== b.vtag && g, M(n, null, b, g), l(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), b.vchildren)
        for (h = 0; h < b.vchildren.length; ++h)
            (w = a(i, b, h, y)) && t.Hn(y, w);
    "svg" === b.vtag && (g = !1);
} return b.i["s-hn"] = f, (b.vt || b.pt) && (b.i["s-sr"] = !0, b.i["s-cr"] = u, b.i["s-sn"] = b.vname || "", (m = i && i.vchildren && i.vchildren[p]) && m.vtag === b.vtag && i.i && s(i.i)), b.i; }, s = function (e, r, i, u) { n.ut = !0; var c = t.qn(e); for (i = c.length - 1; i >= 0; i--)
    ...
    l(n[e]) && (o = n[e].i, i = !0, o["s-ol"] ? t.Fn(o["s-ol"]) : s(o, !0), t.Fn(o)); }, d = function (n, t) { return n.vtag === t.vtag && n.vkey === t.vkey && ("slot" !== n.vtag || n.vname === t.vname); }, h = function (n) { return n && n["s-ol"] ? n["s-ol"] : n; }, y = function (n) { return t.Un(n["s-ol"] ? n["s-ol"] : n); }, w = function (e, r, i) { var o = r.i = e.i, u = e.vchildren, f = r.vchildren; g = r.i && l(t.Vn(r.i)) && void 0 !== r.i.ownerSVGElement, g = "svg" === r.vtag || "foreignObject" !== r.vtag && g, l(r.vtext) ? (i = o["s-cr"]) ? t.Yn(t.Un(i), r.vtext) : e.vtext !== r.vtext && t.Yn(o, r.vtext) : ("slot" !== r.vtag && M(n, e, r, g), l(u) && l(f) ? function (n, e, r, i, o, u, f, c) { for (var b = 0, m = 0, M = e.length - 1, g = e[0], j = e[M], k = i.length - 1, $ = i[0], A = i[k]; b <= M && m <= k;)
    if (null == g)
        g = e[++b];
    else if (null == j)
        j = e[--M];
        ...
        "slot" !== g.vtag && "slot" !== A.vtag || s(t.Un(g.i)), w(g, A), t.X(n, g.i, t.Bn(j.i)), g = e[++b], A = i[--k];
    else if (d(j, $))
        "slot" !== g.vtag && "slot" !== A.vtag || s(t.Un(j.i)), w(j, $), t.X(n, j.i, g.i), j = e[--M], $ = i[++m];
    else {
        ...
        l(o) ? ((c = e[o]).vtag !== $.vtag ? f = a(e && e[m], r, o, n) : (w(c, $), e[o] = void 0, f = c.i), $ = i[++m]) : (f = a(e && e[m], r, m, n), $ = i[++m]), f && t.X(y(g.i), f, h(g.i));
    } b > M ? v(n, null == i[k + 1] ? null : i[k + 1].i, r, i, m, k) : m > k && p(e, b, M); }(o, u, r, f) : l(f) ? (l(e.vtext) && t.Yn(o, ""), v(o, null, r, f, 0, f.length - 1)) : l(u) && p(u, 0, u.length - 1)), g && "svg" === r.vtag && (g = !1); }, b = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.qn(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Nn(e)) {
        if (e["s-sr"])
        ...
        b(e);
    } }, m = [], j = function (n, e, r, o, u, f, c, a, s, l) { for (u = 0, f = (e = t.qn(n)).length; u < f; u++) {
    if ((r = e[u])["s-sr"] && (o = r["s-cr"]))
        for (a = t.qn(t.Un(o)), s = r["s-sn"], c = a.length - 1; c >= 0; c--)
            (o = a[c])["s-cn"] || o["s-nr"] || o["s-hn"] === r["s-hn"] || ((3 === (l = t.Nn(o)) || 8 === l) && "" === s || 1 === l && null === t.Zn(o, "slot") && "" === s || 1 === l && t.Zn(o, "slot") === s) && (m.some(function (n) { return n.dt === o; }) || (i = !0, o["s-sn"] = s, m.push({ ht: r, dt: o })));
    1 === t.Nn(r) && j(r);
} }; return function (a, s, l, v, p, d, h, y, M, g, k, $) { if (c = a, f = t.Gn(c), u = c["s-cr"], e = v, r = c["s-sc"], o = i = !1, w(s, l), o) {
    for (j(l.i), h = 0; h < m.length; h++)
        (y = m[h]).dt["s-ol"] || ((M = t.Ln(""))["s-nr"] = y.dt, t.X(t.Un(y.dt), y.dt["s-ol"] = M, y.dt));
    for (n.ut = !0, h = 0; h < m.length; h++) {
        for (y = m[h], k = t.Un(y.ht), $ = t.Bn(y.ht), M = y.dt["s-ol"]; M = t.In(M);)
            if ((g = M["s-nr"]) && g && g["s-sn"] === y.dt["s-sn"] && k === t.Un(g) && (g = t.Bn(g)) && g && !g["s-nr"]) {
                $ = g;
                break;
            }
    ...
    n.ut = !1;
} return i && b(l.i), m.length = 0, l; }; }(b, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { b.it.set(y, p.loaded = b.bn = !0), h.Xn(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(b, p, r, r["s-apps"], r["s-cr"]), p.initialized = !0, b; }, F = {}, H = !1;
